...
> [!NOTE]
> Make sure you have the latest LTS version of [Node.js](https://nodejs.org/en), [Bun](https://bun.sh/), or [Deno](https://deno.com/) installed.
...
- Learn about dynamic routes, methods, and middleware in [Routing](/docs/routing).
- Serve HTML or a single-page app for unmatched routes with the [renderer](/docs/renderer).
- Take full control of every request with a [server entry](/docs/server-entry).
