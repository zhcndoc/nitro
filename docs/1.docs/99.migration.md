...
Nitro now requires a minimum Node.js version of 20, because Node.js 18 will reach [end of life in April 2025](https://nodejs.org/en/about/previous-releases).

Please upgrade to the [latest LTS](https://nodejs.org/en/download) version (>= 20).

**Migration:**

- Use `node --version` to check your local Node.js version and update it if necessary.
- If you deploy using a CI/CD system, make sure your pipeline is running Node.js 20 or later.
- If your hosting provider manages the Node.js runtime, make sure it is set to version 20, 22, or later.
