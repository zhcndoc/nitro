...
All [`nitro build`](#nitro-build) flags (`--preset`, `--minify`, `--builder`, `--compatibility-date`, ...) are also accepted and applied to the build step. Any arguments after `--` are appended to the underlying deploy command.
